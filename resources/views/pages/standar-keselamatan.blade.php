...
<section class="safety-overview">
    ...
    <div class="overview-box">
        ...
        <p>
            Seluruh armada dilengkapi sistem keamanan sesuai prosedur operasional pelayaran.
        </p>
    ...
    <div class="overview-box">
        ...
        <p>
            Tersedia alat keselamatan lengkap untuk mendukung keamanan penumpang.
        </p>
    ...
    <div class="overview-box">
        ...
        <h3>Kru Profesional</h3>

        <p>
            Kru kapal memiliki pemahaman prosedur keselamatan dan penanganan darurat.
        </p>
    ...
    <div class="overview-box">
        ...
        <h3>Operasional Aman</h3>

        <p>
            Sistem operasional mendukung keamanan pelayaran secara maksimal.
        </p>
